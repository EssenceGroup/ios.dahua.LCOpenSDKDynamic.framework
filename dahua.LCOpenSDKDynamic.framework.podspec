Pod::Spec.new do |s|
  ...
  s.author    = "."
  s.platform     = :ios, "13.0"
  s.pod_target_xcconfig = { 'EXCLUDED_ARCHS[sdk=iphonesimulator*]' => 'arm64 x86_64', 'VALID_ARCHS' => 'arm64 armv7', 'ARCHS' => 'arm64 armv7' }
  s.user_target_xcconfig = { 'EXCLUDED_ARCHS[sdk=iphonesimulator*]' => 'arm64 x86_64', 'VALID_ARCHS' => 'arm64 armv7', 'ARCHS' => 'arm64 armv7' }
